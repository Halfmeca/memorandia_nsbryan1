...
public class EventImpl implements Event, Comparable {
    ...
    private Element _elemement = null;
     ...
     */
    public int getHour() {
        return new Integer(_elemement.getAttribute("hour").getValue()).intValue();
    }
    ...
    public int getMinute() {
        return new Integer(_elemement.getAttribute("min").getValue()).intValue();
    }
    ...
    public CalendarDate getStartDate() {
        Attribute a = _elemement.getAttribute("startDate");
    ...
    public CalendarDate getEndDate() {
        Attribute a = _elemement.getAttribute("endDate");
        if (a != null) return new CalendarDate(a.getValue());
        return null;
    }
    /**
    ...
    public int getPeriod() {
        Attribute a = _elemement.getAttribute("period");
     ...
     */
    public String getId() {
        Attribute a = _elemement.getAttribute("id");
    ...
    public int getRepeat() {
        Attribute a = _elemement.getAttribute("repeat-type");
        if (a != null) return new Integer(a.getValue()).intValue();
        return 0;
    }
    /**
	...
	public boolean getWorkingDays() {
        Attribute a = _elemement.getAttribute("workingDays");
